...
use Drupal\learn\NoteInterface;
 ...
 *     "list_builder" = "Drupal\learn\Entity\Controller\NoteListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\learn\Form\NoteForm",
 *       "edit" = "Drupal\learn\Form\NoteForm",
 *       "delete" = "Drupal\learn\Form\NoteDeleteForm",
 *     },
 *   },
 *   base_table = "note",
 ...
 *   },
 *   links = {
 *     "canonical" = "/note/{d8_note}",
 *     "edit-form" = "/note/{d8_note}/edit",
 *     "delete-form" = "/note/{d8_note}/delete",
...
class Note extends ContentEntityBase implements NoteInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['description'] = BaseFieldDefinition::create('string_long')
      ...
      ->setDescription(t('The description of this Note.'))
      ->setSettings(array(
        'default_value' => '',
        'max_length' => 1000,
        'text_processing' => 0,
